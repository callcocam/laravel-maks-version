    ...
    <div class="row mb-5">
        <div class="col-md-12">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                @endif
                <li class="nav-item"><a class="nav-link active" id="contact-basic-tab" data-toggle="link" href="{{ route('admin.orders-fabrics.edit',$rows->id) }}" role="tab" aria-controls="contactBasic" aria-selected="false">Tecido</a></li>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="fabric" role="tabpanel" aria-labelledby="contact-basic-tab">
                    {!! form_start($form) !!}
                    <div class="row">

                        <div class="col-md-9">
                            {!! form_row($form->fabric->parent) !!}
                        </div>
                        <div class="col-md-3">
                            {!! form_row($form->fabric->submit) !!}
                        </div>

                        <div class="col-md-12">
                            {!! form_row($form->fabrics) !!}
                        </div>
                    </div>
                    {!! form_end($form) !!}
                </div>
